...
<body class="ms-Fabric--isFocusVisible"
    ...
    <div class="es-wrapper-color" style="background-color:#8DD06D">
        <!--[if gte mso 9]>
   <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t">
    <v:fill type="tile" src="{{ asset('images/logo.jpg') }}" color="#8dd06d" origin="0.5, 0" position="0.5, 0"></v:fill>
   </v:background>
  <![endif]-->
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            background="{{ asset('images/logo.jpg') }}"
            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-image:url(https://nszank.stripocdn.email/content/guids/CABINET_cb0b69b95c054f42330a2706fdb2a794/images/loader.jpg);background-repeat:repeat;background-position:center top;background-color:#8DD06D">
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    <table class="es-header" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" bgcolor="#239333" style="padding:0;Margin:0;background-color:#ffffff">
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#25652f"
                                            style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;height:auto;background-color:#25652f">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" spellcheck="false"
                                                                    data-ms-editor="true" style="padding:0;Margin:0">
                                                                    @yield('contenu')
                                                                </td>
                                                            </tr>
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center"
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" spellcheck="false"
                                                                    data-ms-editor="true" bgcolor="#efefef"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Envie de savoir plus sur immo229.com?</h3>
                                                                    <editor-squiggler style="height:0px;width:0px">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td esdev-links-color="#ffa73b" align="center"
                                                                    ...
                                                                    <a href=""
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFA73B;font-size:18px">Contactez-nous
                                                                        à serge@immo229.com</a>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" spellcheck="false"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Nous sommes également joignable par whatsap au
                                                                        +22967566182</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                ...
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#ffffff"
                                            style="Margin:0;padding-top:30px;padding-bottom:30px;padding-left:30px;padding-right:30px;background-color:#ffffff">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" spellcheck="false"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        Pour ne plus reçevoir de mails de notre part,
                                                                        désabonnez-vous ici&nbsp;<strong><a
                                                                                target="_blank" class="unsubscribe"
                                                                                href=""
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left" spellcheck="false"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        immo229 est une initiative de ENIOLA NETWORK
                                                                        SERVICE- Hêvié Rep du BENIN</p>
                                                                    <editor-squiggler style="height:0px;width:0px">
                                                                        <div class="ms-editor-squiggler">
                                                                            <br>
                                                                        </div>
